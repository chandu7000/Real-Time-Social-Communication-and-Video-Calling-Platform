...
const HomePage = () => {
  ...
  const activeQuery = activeSearch
    ? searchQuery
  ...
  const discoveryError = activeQuery.isError
    ? getApiErrorMessage(
        activeQuery.error,
            ...
            <div className="card bg-base-200 p-6 text-center">
              ...
              <p className="opacity-70">
                {activeSearch
                  ...
                  : "There are no new people to recommend right now."}
              </p>
            </div>
          ) : (
                ...
                return (
                  ...
                  >
                    <div className="card-body p-5 space-y-4">
                      ...
                      <p className="text-sm opacity-70 min-h-10 line-clamp-2">
